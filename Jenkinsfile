pipeline {
    ...
    environment {
        ...
        GITHUB_URL = 'https://github.com/thiekend-eng/225-lab3-8.git'  // GitHub repository containing Kubernetes YAML files
        KUBECONFIG = credentials('thiekend-225')             // Jenkins stored credential for accessing your Kubernetes cluster
    }
